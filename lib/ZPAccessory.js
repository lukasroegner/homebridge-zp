...
function ZPAccessory(platform, zp) {
  ...
  this.playService.addOptionalCharacteristic(Characteristic.On);
  this.playService.setCharacteristic(Characteristic.On, false);
  ...
  ZPAccessory.prototype.setPlayOn = function(on, callback) {
    ...
    if (on) {
      ...
      return this.setZoneOn(false, function() {
        this.log.info('%s: left old zone', this.name);
