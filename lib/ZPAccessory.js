...
function ZPAccessory(platform, zp) {
  ...
  this.nightModeService = new Service.Switch(this.zp.zone + ' Night Mode', 'nightmode');
  ...
  this.speechEnhancementService = new Service.Switch(this.zp.zone + ' Speech Enhancement', 'speechenhancement');
