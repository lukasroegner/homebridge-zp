...
ZPAccessory.prototype.handleAVTransportEvent = function(data) {
  ...
  ZPAccessory.prototype.setPlayOn = function(on, callback) {
    ...
    if (this.isCoordinator && this.state.group.track === "TV") {
    ...
    // TODO
    return this.setZoneOn(false, function() { 
      ...
      if (!on) {
        if (!this.state.group.on) {
          ...
          if (!leftGroup) {
            ...
            return this.setGroupOn(false, callback);
          } else {
            return callback();
          }
        }
        ...
        return this.setGroupOn(true, callback);
      }
    }.bind(this));
  };
